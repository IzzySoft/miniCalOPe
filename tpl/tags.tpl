...
<!--link rel="search" type="application/opensearchdescription+xml" title="Project Gutenberg Catalog Search" href="http://m.gutenberg.org/catalog/osd-tags.xml"/-->
<link rel="self" title="Diese Seite" type="application/atom+xml" href="{baseurl}?default_prefix=tags&amp;sort_order=downloads&amp;lang={lang}"/>
...
<link rel="http://opds-spec.org/sort/new" title="Nach Datum sortieren" type="application/atom+xml" href="/ebooks/search.opds/?default_prefix=tags&amp;sort_order=release_date"/-->
...
<content type="text"></content>
<link type="application/atom+xml" href="{baseurl}?default_prefix=tags&amp;sort_order=title&amp;lang={lang}"/>
...
<link type="application/atom+xml" href="{baseurl}?default_prefix=tag_id&amp;sort_order=downloads&amp;query={id}&amp;lang={lang}"/>
