...
<id>{baseurl}?default_prefix=tags&amp;sort_order=downloads</id>
...
<link rel="self" title="Diese Seite" type="application/atom+xml" href="{baseurl}?default_prefix=tags&amp;sort_order=downloads"/>
...
<entry>
<updated>{pubdate}</updated>
<id>{baseurl}?default_prefix=tags&amp;sort_order=title</id>
<title>Alphabetisch sortieren</title>
<content type="text"></content>
<link type="application/atom+xml" href="{relurl}?default_prefix=tags&amp;sort_order=title"/>
...
<entry>
<updated>{pubdate}</updated>
<id>{baseurl}?default_prefix=tag_id&amp;sort_order=downloads&amp;query={id}</id>
<title>{name}</title>
<content type="text">{num_books} {books}</content>
<link type="application/atom+xml" href="{relurl}?default_prefix=tag_id&amp;sort_order=downloads&amp;query={id}"/>
