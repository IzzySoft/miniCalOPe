...
<link rel="http://opds-spec.org/sort/start" title="Gehe an den Start" type="application/atom+xml" href="{baseurl}"/>
...
<content type="text"></content>
<link type="application/atom+xml" href="{baseurl}?default_prefix=titles&amp;sort_order=title&amp;lang={lang}"/>
