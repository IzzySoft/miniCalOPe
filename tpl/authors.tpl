...
<content type="text"></content>
<link type="application/atom+xml" href="{relurl}?default_prefix=authors&amp;sort_order=title&amp;lang={lang}"/>
...
<link type="application/atom+xml" href="{relurl}?default_prefix=author_id&amp;sort_order=downloads&amp;query={id}&amp;lang={lang}"/>
