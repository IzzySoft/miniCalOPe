...
<!-- BEGIN prevblock -->
  <link rel="first" title="{first_page}" type="application/atom+xml" href="{baseurl}?prefix=titles&amp;sort_order={sortorder}&amp;offset=0"/>
  <link rel="previous" title="{prev_page}" type="application/atom+xml" href="{baseurl}?prefix=titles&amp;sort_order={sortorder}&amp;offset={poffset}"/>
<!-- END prevblock -->
<!-- BEGIN nextblock -->
  <link rel="next" title="{next_page}" type="application/atom+xml" href="{baseurl}?prefix=titles&amp;sort_order={sortorder}&amp;offset={noffset}"/>
  <link rel="last" title="{last_page}" type="application/atom+xml" href="{baseurl}?prefix=titles&amp;sort_order={sortorder}&amp;offset={loffset}"/>
<!-- END nextblock -->
  ...
  <link rel="alternate" title="{sort_alpha}"
        type="application/atom+xml;profile=opds-catalog"
        href="{baseurl}?prefix=titles&amp;sort_order=title&amp;lang={lang}"/>
  <link rel="alternate" title="{sort_author}"
        type="application/atom+xml;profile=opds-catalog"
        href="{baseurl}?prefix=titles&amp;sort_order=name&amp;lang={lang}"/>
  <link rel="http://opds-spec.org/sort/new" title="{sort_date}"
        type="application/atom+xml;profile=opds-catalog"
        href="{baseurl}?prefix=titles&amp;sort_order=time&amp;lang={lang}"/>
  ...
  <entry>
    ...
    <id>{baseurl}?prefix=titles&amp;sort_order=title&amp;lang={lang}</id>
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{baseurl}?prefix=titles&amp;sort_order=title&amp;lang={lang}"/>
  ...
  <entry>
    ...
    <id>{baseurl}?prefix=titles&amp;sort_order=name&amp;lang={lang}</id>
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{baseurl}?prefix=titles&amp;sort_order=name&amp;lang={lang}"/>
  ...
  <entry>
    ...
    <id>{baseurl}?prefix=titles&amp;sort_order=time&amp;lang={lang}</id>
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{baseurl}?prefix=titles&amp;sort_order=time&amp;lang={lang}"/>
