...
<feed xmlns="http://www.w3.org/2005/Atom"
  ...
  <id>{baseurl}index.php?prefix=tag_id&amp;sort_order={sortorder}&amp;query={aid}&amp;offset={offset}&amp;lang={lang}</id>
  ...
  <link rel="self" title="{this_page}"
        ...
        href="{baseurl}index.php?prefix=tag_id&amp;sort_order={sortorder}&amp;query={aid}&amp;lang={lang}"/>
<!-- BEGIN prevblock -->
  <link rel="first" title="{first_page}" type="application/atom+xml" href="{baseurl}index.php?prefix=tag_id&amp;sort_order={sortorder}&amp;query={aid}&amp;offset=0"/>
  <link rel="previous" title="{prev_page}" type="application/atom+xml" href="{baseurl}index.php?prefix=tag_id&amp;sort_order={sortorder}&amp;query={aid}&amp;offset={poffset}"/>
<!-- END prevblock -->
<!-- BEGIN nextblock -->
  <link rel="next" title="{next_page}" type="application/atom+xml" href="{baseurl}index.php?prefix=tag_id&amp;sort_order={sortorder}&amp;query={aid}&amp;offset={noffset}"/>
  <link rel="last" title="{last_page}" type="application/atom+xml" href="{baseurl}index.php?prefix=tag_id&amp;sort_order={sortorder}&amp;query={aid}&amp;offset={loffset}"/>
<!-- END nextblock -->
  ...
  <link rel="alternate" title="{sort_author}"
        type="application/atom+xml;profile=opds-catalog"
        href="{baseurl}index.php?prefix=tag_id&amp;sort_order=author&amp;query={aid}&amp;lang={lang}"/>
  <link rel="up" title="{tags_list}"
        type="application/atom+xml;profile=opds-catalog"
        href="{relurl}index.php?prefix=tags&amp;lang={lang}"/>
  <link rel="search"
  ...
  <entry>
    ...
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{baseurl}index.php?prefix=tags&amp;lang={lang}"/>
  ...
  <entry>
    ...
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{baseurl}index.php?prefix=tag_id&amp;sort_order=title&amp;query={aid}&amp;lang={lang}"/>
  ...
  <entry>
    ...
    <id>{baseurl}index.php?prefix=tag_id&amp;sort_order=author&amp;query={aid}&amp;lang={lang}</id>
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{baseurl}index.php?prefix=tag_id&amp;sort_order=author&amp;query={aid}&amp;lang={lang}"/>
  ...
  <!--entry>
    ...
    <id>{baseurl}index.php?prefix=tag_id&amp;sort_order=date&amp;query={aid}&amp;lang={lang}</id>
    <content type="text"></content>
    <link type="application/atom+xml;profile=opds-catalog" href="{relurl}index.php?prefix=tag_id&amp;sort_order=release_date&amp;query={aid}&amp;lang={lang}"/>
