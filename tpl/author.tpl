...
<content type="text"></content>
<link type="application/atom+xml" href="{relurl}?default_prefix=author_id&amp;sort_order=title&amp;query={aid}&amp;lang={lang}"/>
...
<content type="text"></content>
<link type="application/atom+xml" href="{relurl}?default_prefix=author_id&amp;sort_order=release_date&amp;query={aid}&amp;lang={lang}"/>
