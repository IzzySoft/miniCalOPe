...
<entry>
<updated>{pubdate}</updated>
<id>baseurl}?default_prefix=author_id&amp;sort_order=title&amp;query={aid}</id>
<title>Alphabetisch sortieren</title>
<content type="text"></content>
<link type="application/atom+xml" href="{relurl}?default_prefix=author_id&amp;sort_order=title&amp;query={aid}"/>
...
<entry>
<updated>{pubdate}</updated>
<id>{baseurl}?default_prefix=author_id&amp;sort_order=release_date&amp;query={aid}</id>
<title>Nach Datum sortieren</title>
<content type="text"></content>
<link type="application/atom+xml" href="{relurl}?default_prefix=author_id&amp;sort_order=release_date&amp;query={aid}"/>
