...
<link rel="self" title="Diese Seite" type="application/atom+xml" href="{relurl}?action=bookdetails&amp;book={id}"/>
...
<!-- BEGIN itemblock -->
<link type="application/{ftype}" rel="http://opds-spec.org/acquisition" title="{ftitle}" length="{flength}" href="{baseurl}?action=getbook&amp;book={id}&amp;format={format}"/>
<!-- END itemblock -->
</entry>
